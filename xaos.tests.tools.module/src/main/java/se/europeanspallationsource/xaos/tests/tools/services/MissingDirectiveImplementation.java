...
public class MissingDirectiveImplementation implements BasicUsageInterface {
	...
	//
	//	Missing 'provides' directive for se.europeanspallationsource.xaos.tests.tools.MissingDirectiveImplementation annotated service provider.
	...
	//		  with se.europeanspallationsource.xaos.tests.tools.MissingDirectiveImplementation;
